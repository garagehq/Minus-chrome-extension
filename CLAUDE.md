...
| `extension/spanish.js` | `MINUS_DECKS` — flashcard decks (es/fr/de/it/pt/ja) + `MINUS_LANGS` labels; `MINUS_SPANISH` back-compat alias. Loaded by content scripts AND options.html |
