...
for t in test_model_catalog test_overlay_occlusion test_power_pref_strip test_gpu_recovery_unit test_options_decks test_extension_hardening test_learning; do
  echo "===== $t"
